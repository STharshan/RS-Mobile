...
const ServiceCard = ({ service, onClick }) => {
  ...
  return (
    <div
      className={`${service.bgColor || 'bg-white'} p-6 md:p-8 rounded-lg shadow-sm hover:shadow-md transition-all cursor-pointer transform hover:-translate-y-1`}
      onClick={onClick}
    >
      <div className="mb-4">
        <Icon className={`w-12 h-12 md:w-16 md:h-16 ${isHighlighted ? 'text-white' : 'text-[#ef5a24]'}`} />
      </div>
      <h3 className={`text-xl md:text-2xl font-bold mb-3 md:mb-4 ${isHighlighted ? 'text-white' : 'text-gray-900'}`}>
        {service.title}
      </h3>
      <p className={`text-sm md:text-base mb-4 md:mb-6 leading-relaxed ${isHighlighted ? 'text-white' : 'text-gray-600'}`}>
        {service.desc}
      </p>

      {/* Make button block with margin-top */}
      <button
  ...
  const services = [
    {
      ...
      description: 'Keep your car road-legal with our expert mobile MOT repair services in Stamford.',
...
We’ll ensure your car meets all DVSA standards, helping you pass your MOT quickly and hassle-free.`
    },
    {
      ...
      description: 'Stay safe on the road with our mobile brake repair and replacement services in Stamford.',
...
We only use high-quality parts for lasting safety and reliability.`
    },
    {
      ...
      description: 'Experience smoother, more controlled driving with our suspension repair and inspection services across Stamford and nearby areas.',
      features: [
    ...
    },
    {
      ...
      description: 'Keep your vehicle performing at its best with our mobile car servicing in Stamford.',
      features: [
...
No need to visit a garage — we bring dealership-level servicing directly to your door, helping you save time and maintain warranty compliance.`
    ...
    },
    {
      ...
      description: 'Identify vehicle problems fast with our mobile car diagnostics service in Stamford, Lincolnshire.',
      features: [
        `Using advanced diagnostic equipment, we can read engine fault codes, analyse performance data, and pinpoint issues before they become costly repairs. From check-engine lights to electrical problems, we’ll come to you, diagnose the fault, and advise on the best solution — all in one visit.`
      ],
    },
    {
      icon: FaSyncAlt,
      ...
      description: 'Keep your business moving with our fleet and lease vehicle maintenance services in Stamford and surrounding areas.',
      features: [
        `We provide mobile servicing and repairs for companies managing multiple vehicles, ensuring minimal downtime and consistent reliability. With a dedicated account manager and priority call-outs, you’ll always have a trusted partner keeping your fleet road-ready.
Perfect for delivery, construction, and service businesses that rely on dependable transport.`
      ],
    },
