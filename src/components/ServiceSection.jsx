...
const services = [
    {
        ...
        icon: <FaCar className="w-20 h-20 mx-auto mb-4 text-red-600" />,
    },
    {
        id: 2,
        ...
        icon: <FiSettings className="w-20 h-20 mx-auto mb-4 text-red-600" />,
    },
    {
        id: 3,
        ...
        icon: <FiTool className="w-20 h-20 mx-auto mb-4 text-red-600" />,
    },
        {
        id: 4,
        ...
        icon: <MdOutlinePayment className="w-20 h-20 mx-auto mb-4 text-red-600" />,
    },
];
        ...
        <section className="py-20 px-6 bg-white text-black">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2  max-w-6xl mx-auto gap-8">
                {services.map((service) => (
                    <div key={service.id} className="bg-white shadow-lg rounded-xl p-6 text-center">
                        {service.icon}
